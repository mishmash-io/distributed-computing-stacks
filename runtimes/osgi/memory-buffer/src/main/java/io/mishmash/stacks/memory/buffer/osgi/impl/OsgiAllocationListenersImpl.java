...
public class OsgiAllocationListenersImpl implements OsgiAllocationListeners {

    private static final Logger LOG = Logger.getLogger(
            OsgiAllocationListenersImpl.class.getName());
    ...
    @Override
    public OsgiAllocationListener forAllocator(
            final String name) {
        return new Listener(name);
    }

    @Override
    public void unset(final BufferAllocator buf) {
        unset(buf.getName());
    }
    ...
    protected class Listener implements
            OsgiAllocationListeners.OsgiAllocationListener {
        ...
        @Override
        public void setBufferAllocator(final BufferAllocator allocator) {
